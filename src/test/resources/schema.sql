...
CREATE TABLE IF NOT EXISTS SGS_GABARITO (
...
ALTER TABLE SGS_GABARITO_QUESTAO ADD CONSTRAINT FK_SGS_GABARITO_QUESTAO_01 FOREIGN KEY (GABARITO_ID) REFERENCES SGS_GABARITO (GABARITO_ID);
